...
require_relative 'lib/omniauth/line_v2/version'

Gem::Specification.new do |spec|
  spec.name = 'omniauth-line-v2'
  spec.version = OmniAuth::LineV2::VERSION
  ...
  github_root_uri = 'https://github.com/cadenza-tech/omniauth-line-v2'
